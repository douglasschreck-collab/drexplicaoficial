...
with col1:
    ...
    notas_medicas = st.text_area(
        ...
        height=340, 
        placeholder="Digite ou cole observações rápidos... Ex: 'Nódulo hepático segmento VII, hiperecoico, 2cm, sem fluxo ao Doppler...'"
    )
...
with col2:
    ...
    if processar and notas_medicas:
        with st.spinner("Compilando dados estruturados sob diretrizes internacionais..."):
            try:
                # Corrigido para a chamada homologada estável da API
                ...
                # Injetando as instruções do sistema de forma síncrona
