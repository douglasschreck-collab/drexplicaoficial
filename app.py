...
# 3. VERIFICAÇÃO DE CHAVE DE SEGURANÇA
...
# 5. RENDERIZAÇÃO DA INTERFACE (MÓDULO SUPERIOR)
st.markdown("""
    <div class="clinic-top-bar">
        <div class="clinic-brand">Desenvolvido por @DrExplicaOficial</div>
        <div class="clinic-badge">RADAI SUITE v3.0 // PRODUCTION</div>
    </div>
""", unsafe_allow_html=True)
